...
<div id="resulta" class="" >
    <div class="row" style="/*display: -webkit-box;width: 100%; */">
        <div class="sidebar-wrapper col-xs-4 col-md-4">
            ...
            <div class="contact-container container-block">
                <div class="contact-list">
                    <img width="20" src="{{ url('/css/icons/circle-info.svg')}}" />
        ...
        <div class="main-wrapper col-xs-8 col-md-8" style="">
        <section style="white-space: normal;" class="section">
                    ...
                    <div id="secExp">
                        <div class="item">
                            <div class="meta">
                                ...
                                <div class="upper-row inline">
                                    <div class="col-xs-7 compa">Google, California</div>
                                    <div class="col-xs-5 date">2023-01 - 2023-03</div>
                                </div>
                            </div><br/>
                            <div class="text-wrap"><p>gdgdcfdrecdtct  t fgfu hg gfjhyu g gyufyu g  g yg i </p></div>
                        </div>
                        <div class="item">
                            <div class="meta">
                                <div class="upper-row"><h2 class="job-title">Manager</h2></div>
                                <div class="upper-row inline">
                                    <div class="col-xs-7 compa">OCP, Khribga</div>
                                    <div class="col-xs-5 date">2023-01 - 2023-03</div>
                                </div>
                            </div><br/>
                            <div class="text-wrap"><p>nvn, h jkg jgjk hj h h j hkh khkl </p></div
                        ></div>
                    </div>                  
                </section>
                ...
                <section class="skills-section section">
                    ...
                    <div id="skillset">
                        <div class="container">
                        <div class="upper-row inline">
                            <div class="col-xs-3 col-xs-offset-1"><h6 class="level-title">Coding</h6></div>
